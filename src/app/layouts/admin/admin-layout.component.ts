...
export class AdminLayoutComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  userId = window.localStorage.getItem("UserInfo_Id");
  userName = window.localStorage.getItem("UserInfo_Name");
  userRoleName = window.localStorage.getItem("RoleName");
  ...
  ngOnInit(): void {
    // let tokenNo = window.localStorage.getItem("Token");
  ...
  setTitle( newTitle: string) {
    ...
    this.titleService.setTitle( 'Xindots' );
